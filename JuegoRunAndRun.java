...
import RunAndRun.base.Dibujable;
import RunAndRun.base.Juego;
...
public class JuegoRunAndRun extends Juego {
	...
	public void inicializa() {
		...
		contador = 0;
		punto = new Punto("/punt.png", (int) ((Math.random() * 600) + 10), (int) ((Math.random() * 400) + 10),
				(int) ((Math.random() * 40) + 40), (int) (Math.random() * 10 + 1), (int) (Math.random() * 10 + 1));

		while (contador < 4) {
			add(new Enemigo(getEnC(), (int) ((Math.random() * 600) + 50), (int) ((Math.random() * 400) + 50),
